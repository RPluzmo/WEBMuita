<x-layout>
    <main class="dhl-container">
        <div class="dhl-banner"
            style="background-image: url('https://images.unsplash.com/photo-1454165205744-3b78555e5572?q=80&w=1000');">
        ...
        <div>
            <a href="{{ route('kases.create') }}" class="dhl-btn">+ Iesniegt jaunu kravu</a>
        </div>
